...
def calculate_average(biisien_pisteet):
    """
    Laskee sanakirjana annetun tanssipelin eri kappaleista saatujen
    pisteiden keskiarvon

    :param biisien_pisteet: dict, avaimina kappaleiden nimet ja arvoina pisteet
    :return: float, suoritetuista biiseistä saatujen pisteiden keskiarvo
    """
    keskiarvo = sum(biisien_pisteet.values())/(len(biisien_pisteet))
    return keskiarvo
