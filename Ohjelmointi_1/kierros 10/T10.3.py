...
Tehtävä 10.3 Ensimmäinen tehtävä luokista ja olioista.
"""
...
class Person:
    ...
    def move(self, new_address):
        """
        When person moves, address needs to change accordingly.

        :param new_address: str, persons new address
        ...
        if not new_address == "":
            ...
            raise ValueError("New address can't be null")
