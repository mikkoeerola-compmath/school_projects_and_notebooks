...
const checkCSRFtoken = (token) => {
  const a = (t) => {return t === token;}
  let index = csrfTokens.findIndex(a);
  if(index !== -1){
    csrfTokens.splice(csrfTokens.findIndex(a),1);
  }
  return index;
}