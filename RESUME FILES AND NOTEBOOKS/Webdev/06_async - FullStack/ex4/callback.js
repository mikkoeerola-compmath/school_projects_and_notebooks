 ...
 * The first thing you write inside drawArrows function below should be an if statement,
 * the termination condition to return from this function. In the termination condition,
 * you should compare parameter i to the length of actors parameter array. 
 * Notice that you will very likely go through many tries when finding the correct numeric
 * modifiers for all the variables and parameters. Run the provided tests after each change to your code.
 * 
...
const drawArrows = (actors, timeout, drawArrow, i = 0) => {
  if(i < 2*(actors.length)-1) {
    drawArrow(i, actors.length);
