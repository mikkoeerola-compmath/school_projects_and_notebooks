...
// MAGIC * All the students are using the same computational cluster.
...
// MAGIC * Each notebook has a default language. You can select it on the top of the notebook. In this notebook, the default language is "Scala"
...
// MAGIC * [Shared container](https://portal.azure.com/#view/Microsoft_Azure_Storage/ContainerMenuBlade/~/overview/storageAccountId/%2Fsubscriptions%2Fe0c78478-e7f8-429c-a25f-015eae9f54bb%2FresourceGroups%2Ftuni-cs320-f2025-rg%2Fproviders%2FMicrosoft.Storage%2FstorageAccounts%2Ftunics320f2025gen2/path/shared/etag/%220x8DE01A3A1A66C90%22/defaultId//publicAccessVal/None) for example data sets.
// MAGIC * [Student container](https://portal.azure.com/#view/Microsoft_Azure_Storage/ContainerMenuBlade/~/overview/storageAccountId/%2Fsubscriptions%2Fe0c78478-e7f8-429c-a25f-015eae9f54bb%2FresourceGroups%2Ftuni-cs320-f2025-rg%2Fproviders%2FMicrosoft.Storage%2FstorageAccounts%2Ftunics320f2025gen2/path/students/etag/%220x8DE01A3A1A7F5AB%22/defaultId//publicAccessVal/None) where you can store your own data. Please create a folder for yourself with your name.
// MAGIC * You also find all the relevant Azure resources by going to the [Azure portal](https://portal.azure.com) to Storage accounts and select [`tunics320f2025gen2` /  containers](https://portal.azure.com/#@tuni.onmicrosoft.com/resource/subscriptions/e0c78478-e7f8-429c-a25f-015eae9f54bb/resourceGroups/tuni-cs320-f2025-rg/providers/Microsoft.Storage/storageAccounts/tunics320f2025gen2/containersList).
// MAGIC
...
// MAGIC `abfss://<container>@tunics320f2025gen2.dfs.core.windows.net/<path>/<to>/<file.csv>`

// COMMAND ----------

val file_csv = "abfss://shared@tunics320f2025gen2.dfs.core.windows.net/demo/kaggle/csv/10mb_imdb_anime.csv"
...
// MAGIC file = "abfss://shared@tunics320f2025gen2.dfs.core.windows.net/demo/kaggle/csv/10mb_imdb_anime.csv"
// MAGIC df = spark.read  \
...
val file_parquet = "abfss://shared@tunics320f2025gen2.dfs.core.windows.net/demo/kaggle/parquet/10mb_imdb_anime.parquet"
val df_parquet = spark.read.parquet(file_parquet)
display(df_parquet)

// COMMAND ----------

// There is also a possibility to use a more advanced Delta file format, also called "Delta lake table"
// We will cover this later in the course
val file_delta = "abfss://shared@tunics320f2025gen2.dfs.core.windows.net/demo/kaggle/delta/10mb_imdb_anime_delta"
...
val target_path = s"abfss://students@tunics320f2025gen2.dfs.core.windows.net/${student_name}/demo/"
